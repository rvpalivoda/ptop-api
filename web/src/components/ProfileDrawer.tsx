...
export const ProfileDrawer = ({triggerClassName}: Props) => {
    ...
    return (
        <Sheet>
            ...
            <SheetContent side="right" className="bg-gray-900 border-l border-gray-700 p-4 space-y-4 text-white flex flex-col h-full">
                <SheetHeader>
                    <SheetTitle className="text-2xl font-semibold mt-2 text-white">Профиль</SheetTitle>
                </SheetHeader>
                ...
                <div className="space-y-2 flex-1">
                    <Dialog open={showPwdDialog} onOpenChange={setShowPwdDialog}>
                        <DialogTrigger asChild>
                            <button
                                className="w-full flex items-center bg-gray-700 text-white hover:bg-gray-600 px-4 py-2 rounded-md">
                        ...
                        <DialogContent className={modalContentCls}>
                            ...
                            <form onSubmit={handlePasswordSubmit} className="space-y-4 mt-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-300 mb-2">Текущий
                                        пароль</label>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <button
                                            ...
                                            className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-200"
                                        >
                                            {showNewPassword ? <EyeOff className="w-4 h-4"/> :
                                                <Eye className="w-4 h-4"/>}
                                        </button>
                                    </div>
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-300 mb-2">Подтвердите новый
                                        пароль</label>
                                    <input
                                        type="password"
                    ...
                    <Dialog open={showPinDialog} onOpenChange={setShowPinDialog}>
                        <DialogTrigger asChild>
                            <button
                                className="w-full flex items-center bg-gray-700 hover:bg-gray-600 px-4 py-2 rounded-md">
                        ...
                        <DialogContent className={modalContentCls}>
                            ...
                            <div className="space-y-4 mt-4">
                                <input
                                    ...
                                    className={inputStyles}
                                />
                                <button onClick={handleRegenerateWithVerify}
                                        className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700  block w-full mt-2">
                                    Сгенерировать
                                </button>
                                {newSeed && (
                                    <div className="mt-4 text-center">
                                        ...
                                        <div className="flex items-center justify-center space-x-4">
                                            <button type="button" onClick={() => navigator.clipboard.writeText(newSeed)}
